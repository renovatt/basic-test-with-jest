...
describe('RouterLinks Component Tests', () => {
  it('should render RouterLinks component with link and text elements', () => {
    const { getByRole, getByText } = render(<RouterLinks href="/" text="Home" />);
  ...
  it('should call onClick prop when clicked', () => {
    ...
    const { getByRole } = render(<RouterLinks onClick={onClickMock} href='/' text='Home' />);
    const linkElement = getByRole('link');
